...
export default class sportviewall extends Component {
            ...
            <div className="container-fluid custom-container upcomming-drops" id="upcomming-drops">
               <div className="container">
                  <div className="row">
                     ...
                     <div className="col-md-12">
                        <br/>
                        {this.state.getListSport.length === 0? 
...
{item.file_type === 'audio' ? 
   ...
   <div className="timer2">
                       ...
                       />
                          ...
                          <Link to={`${config.baseUrl}itemdetails/${item.item_edition_id}`} className="be-post-title price price-data">$ {item.price}</Link>
